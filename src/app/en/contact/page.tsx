...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Contact CrownPro for professional tree pruning and care services in Antalya. Get a free quote. Available 24/7.',
  alternates: {
    canonical: 'https://antalyaagacbudama.com/en/contact',
    languages: {
  ...
  openGraph: {
    title: 'Contact | CrownPro',
    description: 'Contact CrownPro. Call now for a free quote.',
    url: 'https://antalyaagacbudama.com/en/contact',
    locale: 'en_US',
  },
}
      ...
      <section className="relative bg-[#1a2e1a] py-24 md:py-32">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl text-white/70 max-w-xl mx-auto">
            Get in touch for a free site visit and price quote. Available 24/7.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Muratpaşa, Antalya, Turkey</p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Saturday: 09:00 – 18:00</p>
                  </div>
                </div>
              </div>
            </div>
